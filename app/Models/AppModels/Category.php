 ...
 public static function getMainCategories($language_id)
{
  ...
  ->select('categories.categories_id as id', 'image_categories.path as image','categories.categories_slug as slug','categories_description.categories_name as name')
