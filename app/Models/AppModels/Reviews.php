...
class Reviews extends Model
{
    public static function givereview($request)
    {
        ...
        if ($authenticate == 1) {
            ...
            if (count($reviews) == 0) {
                ...
                $responseData = array(
                    'success' => '1', 'data' => array(), 'message' => 'Product is reviewed successfully!'
                );
            } else {
                $responseData = array(
                    'success' => '1', 'data' => array(),
                    'message' => 'You have already given the review for this product.'
                );
            }
        } else {
    ...
    public static function updatereview($request)
    {
        ...
        if ($authenticate == 1) {
            ...
            if ($reviews) {
                ...
                $responseData = array(
                    'success' => '1', 'data' => array(), 'message' => 'Your review has been updated successfully!'
                );
            } else {
                $responseData = array(
                    'success' => '1', 'data' => array(), 'message' => 'You dont have any review for this product.'
                );
            }
        } else {
            $responseData = array('success' => '0', 'data' => array(), 'message' => "Unauthenticated call.");
    ...
    public static function getreviews($request)
    {
        ...
        if ($authenticate == 1) {
            ...
            if ($reviews) {
                $responseData = array(
                    'success' => '1', 'data' => $reviews, 'message' => 'Product rating has been returned!'
                );
            } else {
