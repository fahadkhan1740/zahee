...
class Images extends Model
{
    ...
    public function getimages()
    {
        ...
        return $allimages->merge($allimagesth)->keyBy('id');
    }
    ...
    public function thumbnailHeightWidth()
    {
        ...
        return array($Thumbnail_height[0], $Thumbnail_width[0]);
    }
    ...
    public function MediumHeightWidth()
    {
        ...
        return array($Medium_height[0], $Medium_width[0]);
    }
    ...
    public function LargeHeightWidth()
    {
        ...
        return array($Large_height[0], $Large_width[0]);
    }
    ...
    public function AllimagesHeightWidth()
    {
        ...
        $AllImagessetting = array(
            $Thumbnail_height[0], $Thumbnail_width[0], $Medium_height[0], $Medium_width[0], $Large_height[0],
            $Large_width[0]
        );
