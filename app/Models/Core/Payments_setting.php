...
class Payments_setting extends Model
{
    ...
    {
        $shipping_methods = Payments_setting::leftJoin('payment_description', 'payment_description.payment_methods_id',
    ...
    public function updaterecord($request)
    {
        ...
        $result = DB::table('payment_methods_detail')->where('payment_methods_detail.payment_methods_id',
            $request->id)->get();
        ...
        foreach ($languages as $languages_data) {
            ...
            $checkExist = DB::table('payment_description')->where('payment_methods_id', '=', $id)->where('language_id',
                '=', $languages_data->languages_id)->first();

            if ($checkExist) {
                DB::table('payment_description')->where('payment_methods_id', '=', $id)->where('language_id', '=',
                    $languages_data->languages_id)->update([
                    'name' => $request->$name,
                    'language_id' => $languages_data->languages_id,
                ]);
            } else {
    ...
    public function display($id)
    {
        ...
        $payment_credentials = DB::table('payment_methods_detail')->where('payment_methods_detail.payment_methods_id',
            $id)->get();
    ...
    {
        $checkExist = DB::table('payment_description')->where('payment_name', '=',
            $braintree_name)->where('language_id', '=', $languages_data->languages_id)->get();
        return $checkExist;
    }

    public function ifcheckisset($braintree_name, $languages_data, $re_braintreeName, $req_sub_name_1, $req_sub_name_2)
    {
        $checkisset = DB::table('payment_description')->where('payment_name', '=',
            $braintree_name)->where('language_id', '=', $languages_data->languages_id)->update([
    ...
    public function ifcheckisnotset(
        $re_braintreeName,
        $req_sub_name_1,
        $req_sub_name_2,
        $languages_data,
    ...
    {
        $checkExist = DB::table('payment_description')->where('payment_name', '=', $stripe_name)->where('language_id',
            '=', $languages_data->languages_id)->get();
        return $checkExist;
    }

    public function validCheck($stripe_name, $languages_data, $req_stripeName)
    {
        $issetstripe = DB::table('payment_description')->where('payment_name', '=', $stripe_name)->where('language_id',
            '=', $languages_data->languages_id)->update([
            'name' => $req_stripeName,
        ]);
        return $issetstripe;
    ...
    {
        $checkExist = DB::table('payment_description')->where('payment_name', '=', $paypal_name)->where('language_id',
            '=', $languages_data->languages_id)->get();
        return $checkExist;
    }
    ...
    {
        $paypalcheck = DB::table('payment_description')->where('payment_name', '=', $paypal_name)->where('language_id',
            '=', $languages_data->languages_id)->update([
            'name' => $req_paypalName,
        ]);
        return $paypalcheck;
    ...
    {
        $checkExist = DB::table('payment_description')->where('payment_name', '=',
            $cybersource_name)->where('language_id', '=', $languages_data->languages_id)->get();
        return $checkExist;
    }

    public function validsybercheck($cybersource_name, $languages_data, $req_cybersourceName)
    {
        $validcheck = DB::table('payment_description')->where('payment_name', '=',
            $cybersource_name)->where('language_id', '=', $languages_data->languages_id)->update([
    ...
    {
        $checkExist = DB::table('payment_description')->where('payment_name', '=', $cod_name)->where('language_id', '=',
            $languages_data->languages_id)->get();
        return $checkExist;
    }
    ...
    {
        $Codecheck = DB::table('payment_description')->where('payment_name', '=', $cod_name)->where('language_id', '=',
            $languages_data->languages_id)->update([
            'name' => $req_codName,
        ]);
        return $Codecheck;
    ...
    {
        $checkExist = DB::table('payment_description')->where('payment_name', '=',
            $instamojo_name)->where('language_id', '=', $languages_data->languages_id)->get();
        return $checkExist;
    }

    public function validchekkinstamojo($instamojo_name, $languages_data, $req_instamojoName)
    {
        $intamojo = DB::table('payment_description')->where('payment_name', '=', $instamojo_name)->where('language_id',
            '=', $languages_data->languages_id)->update([
    ...
    {
        $checkExist = DB::table('payment_description')->where('payment_name', '=', $hyperpay_name)->where('language_id',
            '=', $languages_data->languages_id)->get();
        return $checkExist;
    }
    ...
    {
        DB::table('payment_description')->where('payment_name', '=', $hyperpay_name)->where('language_id', '=',
            $languages_data->languages_id)->update([
