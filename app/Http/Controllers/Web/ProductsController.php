...
class ProductsController extends Controller
{
    ...
    public function filterProducts(Request $request)
    {
        ...
        $data = array(
            'page_number' => $request->page_number, 'type' => $type, 'limit' => $limit,
            'categories_id' => $categories_id, 'search' => $search, 'filters' => $filters, 'limit' => $limit,
...
//            dd($valueCheck);
    ...
    public function find_key_value($array, $val)
    {
        foreach ($array as $item) {
            if (isset($item->products_id) && $item->products_id === $val) {
                return true;
            }
        }
        return false;
