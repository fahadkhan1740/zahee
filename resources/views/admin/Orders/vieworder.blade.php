    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ URL::to('admin/orders/display')}}"><i
                            class="fa fa-dashboard"></i> {{ trans('labels.ListingAllOrders') }}</a></li>
        ...
        <section class="invoice" style="margin: 15px;">
            ...
            <div class="row invoice-info">
                <div class="col-sm-4 invoice-col">
                    ...
                    <address>
                        ...
                        , {{ $data['orders_data'][0]->customers_state }} {{ $data['orders_data'][0]->customers_postcode }}
                ...
                <div class="col-sm-4 invoice-col">
                    ...
                    <address>
                        ...
                        , {{ $data['orders_data'][0]->delivery_state }} {{ $data['orders_data'][0]->delivery_postcode }}
                        , {{ $data['orders_data'][0]->delivery_country }}<br>

                        <strong>{{ trans('labels.Phone') }}: </strong>{{ $data['orders_data'][0]->delivery_phone }}<br>
                        <strong> {{ trans('labels.ShippingMethod') }}
                            :</strong> {{ $data['orders_data'][0]->shipping_method }} <br>
                        <strong> {{ trans('labels.ShippingCost') }}
                            :</strong> @if(!empty($data['orders_data'][0]->shipping_cost)) {{ $data['currency'][19]->value }} {{ $data['orders_data'][0]->shipping_cost }} @else
                            --- @endif <br>
                    </address>
                </div>
                <!-- /.col -->
                <div class="col-sm-4 invoice-col">
                    ...
                    <address>
                        ...
                        , {{ $data['orders_data'][0]->billing_state }} {{ $data['orders_data'][0]->billing_postcode }}
            ...
            <div class="row">
                ...
                <div class="col-xs-7">
                    ...
                    @if(!empty($data['orders_data'][0]->coupon_code))
                        ...
                        <table class="text-muted well well-sm no-shadow stripe-border table table-striped"
          ...
          <img src="../../dist/img/credit/paypal2.png" alt="Paypal">-->
                    ...
                    <p class="text-muted well well-sm no-shadow"
                       style="text-transform:capitalize; word-break:break-all;">
                            ...
                            <select class="form-control select2" id="status_id" name="orders_status"
                                ...
                                @foreach( $data['orders_status'] as $orders_status)
                                    <option value="{{ $orders_status->orders_status_id }}"
                                            @if( $data['orders_data'][0]->orders_status_id == $orders_status->orders_status_id) selected="selected" @endif >{{ $orders_status->orders_status_name }}</option>
                                @endforeach
                            </select>
                ...
                <div class="col-xs-12">
                    <a href="{{ URL::to('admin/orders/display')}}" class="btn btn-default"><i
