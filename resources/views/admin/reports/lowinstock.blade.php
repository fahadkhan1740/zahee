...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> {{ trans('labels.Low Stock Products') }} <small>{{ trans('labels.Low Stock Products') }}...</small>
            </h1>
            <ol class="breadcrumb">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a data-toggle="tooltip" data-placement="bottom"
                                                           ...
                                                           href="stockin?products_id={{ $lowQunatityProducts['products_id'] }}"
                                                           class="badge bg-light-blue"><i class="fa fa-eye"
