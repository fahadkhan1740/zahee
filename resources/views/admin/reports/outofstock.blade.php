...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> {{ trans('labels.Productsoutofstock') }} <small>{{ trans('labels.Productsoutofstock') }}...</small>
            </h1>
            <ol class="breadcrumb">
                                        ...
                                        @if(count($result['products']) > 0)
                                            @foreach ($result['products'] as  $key=>$outOfStockData)
                                                <tr>
                                                    ...
                                                    <td><img src="{{asset('/'.$outOfStockData->path)}}" alt=""
                                                    ...
                                                    <td>
                                                        <a data-toggle="tooltip" data-placement="bottom"
                                                           ...
                                                           href="stockin?products_id={{ $outOfStockData->products_id }}"
