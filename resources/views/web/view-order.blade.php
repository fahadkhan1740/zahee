                    ...
                    <div class="row">
                                ...
                                <tr class="d-flex">
                                    ...
                                    @if($result['orders'][0]->orders_status_id == '1')
                                        <td class="col-6 col-md-6">
                                            <span
                                                class="badge badge-primary">{{$result['orders'][0]->orders_status}}</span>
                                        </td>
                                    @elseif($result['orders'][0]->orders_status_id == '2')
                                        <td class="col-6 col-md-6">
                                            <span
                                                class="badge badge-success">{{$result['orders'][0]->orders_status}}</span>
                                        </td>
                                    @elseif($result['orders'][0]->orders_status_id == '3')
                                        <td class="col-6 col-md-6">
                                            <span
                                                class="badge badge-danger">{{$result['orders'][0]->orders_status}}</span>
                                        </td>
                                    @else
                                        <td class="col-6 col-md-6">
                                            <span
                                                class="badge badge-warning">{{$result['orders'][0]->orders_status}}</span>
                                        </td>
                                    @endif
                                </tr>
                                <tr class="d-flex">
                                    <td class="col-6 col-md-6">Order Date</td>
                                    <td class="underline col-6 col-md-6"
                                        align="left">{{ date('d/m/Y', strtotime($result['orders'][0]->date_purchased))}}</td>
                                </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="col-12 col-md-7">
                            ...
                            <table class="table order-id">
                                ...
                                <tr class="d-flex">
                                    <td class="address col-12 col-md-12">{{$result['orders'][0]->delivery_street_address}}
                                        , {{$result['orders'][0]->delivery_city}}
                                        , {{$result['orders'][0]->delivery_state}},
                                        {{$result['orders'][0]->delivery_postcode}}
                                        , {{$result['orders'][0]->delivery_country}}</td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-5">
                            ...
                            <table class="table order-id">
                                ...
                                <tr class="d-flex">
                                    <td class="address col-12">{{$result['orders'][0]->billing_street_address}}
                                        , {{$result['orders'][0]->billing_city}}
                                        , {{$result['orders'][0]->billing_state}},
                                        {{$result['orders'][0]->billing_postcode}}
                                        , {{$result['orders'][0]->billing_country}}</td>
                                </tr>
                                </tbody>
                            </table>
                            ...
                            @foreach( $result['orders'][0]->products as $products)
                                ...
                                <tr class="d-flex responsive-lay">
                                    <td class="col-12 col-md-2">
                                        <img class="img-fluid order-img" src="{{asset('public/'.$products->image)}}"
                                             alt="{{$products->products_name}}" class="mr-3">
                                    </td>
                                                    ...
                                                    @if(count($products->attributes) >0)
                                                        <ul>
                                                            @foreach($products->attributes as $attributes)
                                                                <li>{{$attributes->products_options}}
                                                                    <span>{{$attributes->products_options_values}}</span>
                                                                </li>
                                                            @endforeach
                                                        </ul>
                                                    @endif
                                    ...
                                    <td class="tag-color col-12 col-md-3">{{$result['orders'][0]->currency}}{{$products->final_price/$products->products_quantity}}</td>
                                    <td class="col-12 col-md-2">
                                        <div class="input-group">
                                            <input name="quantity[]" type="text" readonly
                                                   value="{{$products->products_quantity}}"
                                                   class="form-control qty" min="1" max="300">
                                    ...
                                    @endphp
                                    <td class="tag-s col-12 col-md-2">{{Session::get('symbol_left')}}{{$products->final_price+0*$currency_value}}{{Session::get('symbol_right')}}</td>
                                </tr>
                            @endforeach
                        @endif
