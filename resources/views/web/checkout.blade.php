        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-xl-9 checkout-left">
                    ...
                    <div class="alert alert-danger alert-dismissible" id="paymentError" role="alert"
                         style="display:none;">
                        ...
                        <ul class="nav nav-pills mb-3 checkoutd-nav d-none d-lg-flex" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link @if(session('step')==0) active @elseif(session('step')>0) active-check @endif"
                                   ...
                                   aria-selected="true">@lang('website.Shipping Address')</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @if(session('step')==1) active @elseif(session('step')>1) active-check @endif"
                                   @if(session('step')>=1) id="pills-billing-tab" data-toggle="pill"
                                   href="#pills-billing" role="tab" aria-controls="pills-billing"
                                   aria-selected="false" @endif >@lang('website.Billing Address')</a>
                            </li>
                        <!-- <li class="nav-item">
                   <a class="nav-link @if(session('step')==2) active @elseif(session('step')>2) active-check @endif" @if(session('step')>=2) id="pills-method-tab" data-toggle="pill" href="#pills-method" role="tab" aria-controls="pills-method" aria-selected="false" @endif> @lang('website.Shipping Methods')</a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if(session('step')==3) active @elseif(session('step')>3) active-check @endif"
                                   @if(session('step')>=3) id="pills-order-tab" data-toggle="pill" href="#pills-order"
                                   role="tab" aria-controls="pills-order"
                                   aria-selected="false"@endif>@lang('website.Order Detail')</a>
                            </li>
                        </ul>
                   ...
                   <a class="nav-link @if(session('step')==2) active @elseif(session('step')>2) active-check @endif" @if(session('step')>=2) id="pills-method-tab" data-toggle="pill" href="#pills-method" role="tab" aria-controls="pills-method" aria-selected="false" @endif>3</a>
                            ...
                            <li class="nav-item fourth">
                                <a class="nav-link @if(session('step')==3) active @elseif(session('step')>3) active-check @endif"
                                   @if(session('step')>=3) id="pills-order-tab" data-toggle="pill" href="#pills-order"
                                   role="tab" aria-controls="pills-order" aria-selected="false"@endif>4</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade @if(session('step') == 0) show active @endif" id="pills-shipping"
                                ...
                                <form name="signup" enctype="multipart/form-data" class="form-validate"
                                    ...
                                    <input type="hidden" required name="_token" id="csrf-token"
                                           value="{{ Session::token() }}"/>
                                    <div class="form-group">
                                        ...
                                        <input type="text" required class="form-control field-validate" id="firstname"
                                               name="firstname"
                                               value="@if((!empty(session('shipping_address')))>0){{session('shipping_address')->firstname}}@endif"
                                               aria-describedby="NameHelp1" placeholder="Enter Your Name">
                                        <span style="color:red;" class="help-block error-content"
                                              hidden>@lang('website.Please enter your first name')</span>
                                    </div>
                                    <div class="form-group">
                                        <label for="lastName">@lang('website.Last Name')</label>
                                        <input type="text" required class="form-control field-validate" id="lastname"
                                               name="lastname"
                                               value="@if((!empty(session('shipping_address')))>0){{session('shipping_address')->lastname}}@endif"
                                               aria-describedby="NameHelp1" placeholder="Enter Your Last Name">
                                        <span style="color:red;" class="help-block error-content"
                                              hidden>@lang('website.Please enter your last name')</span>
                                    </div>

                                    <div class="form-group">
                                        <label for="exampleInputAddress1">@lang('website.Address')</label>
                                        <input type="text" required class="form-control field-validate" name="flat"
                                               id="flat" aria-describedby="addressHelp"
                                               value="@if((!empty(session('shipping_address')))>0){{session('shipping_address')->flat}}@endif"
                                               placeholder="@lang('website.address_flat')">
                                        <br>
                                        <input type="text" required class="form-control field-validate" name="street"
                                               id="street" aria-describedby="addressHelp"
                                               value="@if((!empty(session('shipping_address')))>0){{session('shipping_address')->street}}@endif"
                                               placeholder="@lang('website.address_street')">
                                        <span style="color:red;" class="help-block error-content"
                                              hidden>@lang('website.Please enter your address')</span>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="select-control">
                                            <select required class="form-control field-validate" id="entry_country_id"
                                                    name="countries_id" aria-describedby="countryHelp">
                                                ...
                                                @if((!empty($result['countries']))>0)
                                                    @foreach($result['countries'] as $countries)
                                                        <option value="{{$countries->countries_id}}"
                                                                @if((!empty(session('shipping_address')))>0) @if(session('shipping_address')->countries_id == $countries->countries_id) selected @endif @endif >{{$countries->countries_name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                        <span style="color:red;" class="help-block error-content"
                                              hidden>@lang('website.Please select your country')</span>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleSelectCity1">City</label>
                                        <input required type="text" class="form-control field-validate" id="city"
                                               name="city"
                                               value="@if((!empty(session('shipping_address')))>0){{session('shipping_address')->city}}@endif"
                                               placeholder="Enter Your City">
                                        <span style="color:red;" class="help-block error-content"
                                              hidden>@lang('website.Please enter your city')</span>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="delivery_phone"
                                               aria-describedby="numberHelp" placeholder="Enter Your Phone Number"
                                               name="delivery_phone" value="">
                                        <span style="color:red;" class="help-block error-content"
                                              hidden>@lang('website.Please enter your valid phone number')</span>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <span style="color:red;" class="help-block error-content"
                                              hidden>@lang('website.Please select your address type')</span>
                                    </div>
                                    <div class="col-12 col-sm-12">
                                        <div class="row">
                                            <button type="submit"
                                                    class="btn btn-secondary">@lang('website.Continue')</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <div class="tab-pane fade @if(session('step') == 1) show active @endif" id="pills-billing"
                                ...
                                <form name="signup" enctype="multipart/form-data"
                                      action="{{ URL::to('/checkout_billing_address')}}" method="post">
                                    <input type="hidden" name="_token" id="csrf-token" value="{{ Session::token() }}"/>
                                    <div class="form-group">
                                        <label for="exampleInputName1">@lang('website.First Name')</label>
                                        <input type="text" class="form-control same_address"
                                               @if((!empty(session('billing_address')))>0) @if(session('billing_address')->same_billing_address==1) readonly
                                               @endif @else readonly @endif  id="billing_firstname"
                                               name="billing_firstname"
                                               value="@if((!empty(session('billing_address')))>0){{session('billing_address')->billing_firstname}}@endif"
                                               aria-describedby="NameHelp1" placeholder="Enter Your Name">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control same_address"
                                               aria-describedby="NameHelp2" placeholder="Enter Your Name"
                                               @if((!empty(session('billing_address')))>0) @if(session('billing_address')->same_billing_address==1) readonly
                                               @endif @else readonly @endif  id="billing_lastname"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control same_address"
                                               ...
                                               placeholder="@lang('website.address_flat')"
                                               @if((!empty(session('22')))>0) @if(session('billing_address')->same_billing_address==1) readonly
                                               @endif @else readonly @endif  id="billing_flat" name="billing_flat"
                                               value="@if((!empty(session('billing_address')))>0){{session('billing_address')->billing_flat}}@endif">
                                        <br>
                                        <input type="text" class="form-control same_address"
                                               aria-describedby="addressHelp"
                                               placeholder="@lang('website.address_street')"
                                               @if((!empty(session('22')))>0) @if(session('billing_address')->same_billing_address==1) readonly
                                               @endif @else readonly @endif  id="billing_street" name="billing_street"
                                    ...
                                    <div class="form-group">
                                        <label for="exampleSelectCountry1">@lang('website.Country')</label>
                                        <div class="select-control">
                                            <select required class="form-control same_address_select"
                                                    id="billing_countries_id" aria-describedby="countryHelp"
                                                    onChange="getBillingZones();" name="billing_countries_id"
                                                    @if((!empty(session('billing_address')))>0) @if(session('billing_address')->same_billing_address==1) disabled
                                                    @endif @else disabled @endif>
                                                <option value="">@lang('website.Select Country')</option>
                                                @if((!empty($result['countries']))>0)
                                                    @foreach($result['countries'] as $countries)
                                                        <option value="{{$countries->countries_id}}"
                                                                @if((!empty(session('billing_address')))>0) @if(session('billing_address')->billing_countries_id == $countries->countries_id) selected @endif @endif >{{$countries->countries_name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control same_address"
                                               @if((!empty(session('billing_address')))>0) @if(session('billing_address')->same_billing_address==1) readonly
                                               @endif @else readonly @endif  id="billing_city" name="billing_city"
                                               value="@if((!empty(session('billing_address')))>0){{session('billing_address')->billing_city}}@endif"
                                               placeholder="Enter Your City">
                                        <span class="help-block error-content"
                                              hidden>@lang('website.Please enter your city')</span>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control same_address"
                                               @if((!empty(session('billing_address')))>0) @if(session('billing_address')->same_billing_address==1) readonly
                                               @endif @else readonly @endif  id="billing_phone" name="billing_phone"
                                               value="@if((!empty(session('billing_address')))>0){{session('billing_address')->billing_phone}}@endif"
                                               aria-describedby="numberHelp" placeholder="Enter Your Phone Number">
                                        <span class="help-block error-content"
                                              hidden>@lang('website.Please enter your valid phone number')</span>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control"
                                                @if((!empty(session('billing_address')))>0) @if(session('billing_address')->same_billing_address==1) readonly
                                                @endif @else readonly @endif  id="billing_address_type"
                                                name="billing_address_type">
                                            <option
                                                value="home" @if((!empty(session('billing_address')))>0 && (session('billing_address')->billing_address_type === 'home')){{'selected'}} @endif> @lang('website.home')</option>
                                            <option
                                                value="office" @if((!empty(session('billing_address')))>0 && (session('billing_address')->billing_address_type === 'office')){{'selected'}} @endif>@lang('website.office')</option>
                                        </select>
                                        <span style="color:red;" class="help-block error-content"
                                              hidden>@lang('website.Please select your address type')</span>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="same_billing_address"
                                                   value="1" name="same_billing_address"
                                                   @if((!empty(session('billing_address')))>0) @if(session('billing_address')->same_billing_address==1) checked
                                    ...
                                    <div class="col-12 col-sm-12">
                                        <div class="row">
                                            <button type="submit" class="btn btn-secondary"><span>@lang('website.Continue')<i
                        ...
                        <!-- <div class="tab-pane fade  @if(session('step') == 2) show active @endif" id="pills-method" role="tabpanel" aria-labelledby="pills-method-tab">
                            ...
                            <div class="tab-pane fade @if(session('step') == 3) show active @endif" id="pills-order"
                                 role="tabpanel" aria-labelledby="pills-method-order">
                                <?php
                                $price = 0;
                                ?>
                                <form method='POST' id="update_cart_form" action="{{ URL::to('/place_order')}}">
                                    ...
                                    <table class="table top-table">
                                        ...
                                        @foreach( $result['cart'] as $products)
                                            <?php
                                            $default_currency = DB::table('currencies')->where(
                                    'is_default',
                                    1
                                )->first();
                                            if ($default_currency->id == Session::get('currency_id')) {
                                                ...
                                                $session_currency = DB::table('currencies')->where(
                                                    'id',
                                                    Session::get('currency_id')
                                                )->first();
                                            ...
                                            <tr class="d-flex">
                                                    ...
                                                    <div class="item-detail">
                                                        ...
                                                        <div class="item-controls">
                                                            <a class="btn btn-default"
                                                               href="{{ URL::to('/product-detail/'.$products->products_slug)}}">Edit</span></a>
                                                            <a class="btn btn-default"
                                                               href="{{ URL::to('/deleteCart?id='.$products->customers_basket_id)}}">Delete</a>
                                                ...
                                                <td class="align-middle item-total col-12 col-md-2 subtotal"
                                                    align="center"><span
                                                        class="cart_price_{{$products->customers_basket_id}}">{{Session::get('symbol_left')}}{{$orignal_price * $products->customers_basket_quantity}}{{Session::get('symbol_right')}}</span>
                                                </td>
                                            </tr>
                                            <!-- <tr class="d-flex">
                                        ...
                                        <div class="form-group" style="width:100%; padding:0;">
                                            ...
                                            <form name="shipping_mehtods" method="post" id="payment_mehtods_form"
                                                ...
                                                <input type="hidden" name="_token" id="csrf-token"
                                                       value="{{ Session::token() }}"/>
                                                <ul class="list"
                                                    style="list-style:none; padding: 0px;display: flex; justify-content: space-between;">
                                                    @foreach($result['payment_methods'] as $payment_methods)
                                                        <li>
                                                            <input type="radio" name="payment_method"
                                                                   class="payment_method"
                                                                   value="{{$payment_methods->PaymentMethodId}}">
                                                            <label for="{{$payment_methods->PaymentMethodEn}}">
                                                                <img src="{{$payment_methods->ImageUrl}}"
                                                                     alt="{{$payment_methods->PaymentMethodEn}}"/>
                                                            </label>
                                                        </li>
