                                        ...
                                        <div class="cart-item-sb-wrap cart-item-top">
                                                ...
                                                <div class="cart-item-sb-col cart-item-sb-col-right cart-item-product-detail">
                                                    ...
                                                    <p>
                                                        ...
                                                        @else
                                                            <span class="instock" style="color: #4CAF50;font-size: 16px;font-weight: 500;"><i class="fas fa-check"></i> @lang('website.In stock')</span>
                                                        @endif
                                                    </p>
                                                    <?php
                                                    $default_currency = DB::table('currencies')->where('is_default',1)->first();
                                                    ...
                                                    <div class="price">
                                                        ...
                                                        @else
                                                        <span class="new-price">@lang('website.Price') @if(Session::get('direction') == 'ltr')  {{Session::get('symbol_left')}} @endif  {{($orignal_price+0)}} @if(Session::get('direction') == 'rtl'){{Session::get('symbol_right')}}  @endif</span>
                                                        <br>
                                    ...
                                    @else
                                        <div class="cart-item">
                                            <div class="cart-item-col cart-item-center">
                                                <figure>
                                                    <img src="{{asset('web/images/cus/empty-cart.png')}}" alt="empty-cart" style="width:15%">
                    ...
                    <div class="col-12 col-lg-6">
                        <form id="apply_coupon" class="form-validate coupen__wrap">
                            <div class="input-group ">
                                <input type="text"  id="coupon_code" name="coupon_code" class="form-control" placeholder="@lang('website.Coupon Code')">
                            ...
                            <div class="cart-amount-wrap">
                                <ul>
                                    <li>
                                        ...
                                        <span class="cart-price-col">@if(Session::get('direction') == 'ltr')  {{Session::get('symbol_left')}} @endif {{($currency_value * $price)+0}} @if(Session::get('direction') == 'rtl'){{Session::get('symbol_right')}} @endif</span>
                                    </li>
