                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-9">
                        <form method='POST' id="update_cart_form" action='{{ URL::to('/updateCart')}}'>
                                    ...
                                    <tr class="d-flex">
                                        <td class="col-12 col-md-2">
                                            <a href="{{ URL::to('/product-detail/'.$products->products_slug)}}"
                                               class="cart-thumb">
                                                <img class="img-fluid" src="{{url('/').$products->image_path)}}"
                          ...
                          <span class="input-group-btn qtyminuscart">
                              <button class="btn btn-defualt" type="button"><i class="fa fa-minus"
                                                                               aria-hidden="true"></i></button>
                            </span>
                                                <input name="quantity[]" type="text" readonly
                                                       value="{{$products->customers_basket_quantity}}"
                                                       class="form-control qty" min="{{$products->min_order}}"
                                                       max="{{$products->max_order}}">
                                                <span class="input-group-btn qtypluscart">
                              <button class="btn btn-defualt" type="button"><i class="fa fa-plus"
                                                                               aria-hidden="true"></i></button>
                            </span>
                                            </div>
                                        </td>
                                    ...
                                    <tr class="d-flex">
                                        <td class="col-12 col-md-2 p-0">
                                            <div class="item-controls">
                                                <a href="{{ url('/editcart/'.$products->customers_basket_id.'/'.$products->products_slug)}}"
                                                   class="btn">
                            ...
                            <div class="form-group">
                                @foreach(session('coupon') as $coupons_show)
                                    ...
                                    <div class="alert alert-success">
                                        ...
                                        .@lang('website.If you do note want to apply this coupon just click cross button of this alert.')
                                    </div>
                        ...
                        <div class="col-12 col-lg-12 mb-4">
                            <div class="row justify-content-between click-btn">
                                        ...
                                        <div class="row">
                                            <div class="input-group">
                                                <input type="text" name="coupon_code" class="form-control"
                                                       ...
                                                       aria-label="Coupon Code" aria-describedby="coupon-code">
                                ...
                                <div class="col-12 col-lg-7 align-right">
                                    <a href="{{ URL::to('/shop')}}"
                                       class="btn btn-outline-primary">@lang('website.Back To Shopping')</a>
                                ...
                                <div id="coupon_require_error" class="help-block"
                                     style="display: none;color:red;">@lang('website.Please enter a valid coupon code')</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-3">
                        ...
                        <a href="{{ URL::to('/checkout')}}"
                           class="btn btn-secondary m-btn col-12">@lang('website.proceedToCheckout')</a>
                    </div>
                </div>
            </div>
        </div>
