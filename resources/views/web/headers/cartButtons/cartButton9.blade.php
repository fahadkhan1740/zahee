<?php $qunatity=0; ?>
                ...
                <a href="" id="dropdownCartButton_9" class="dropdown-toggle cart-down" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  @if(count($result['commonContent']['cart'])>0)
                      <span class="badge badge-secondary">{{ count($result['commonContent']['cart']) }}&nbsp;@lang('website.items')</span>
                  @else
