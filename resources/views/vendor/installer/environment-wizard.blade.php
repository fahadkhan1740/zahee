                ...
                <!-- <div class="block">
                    ...
                    <div class="info">
                        ...
                        <div class="form-group {{ $errors->has('mail_driver') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="mail_driver" id="mail_driver" value="{{ old('mail_driver') }}" placeholder="Mail Driver" />
                        ...
                        <div class="form-group {{ $errors->has('mail_host') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="mail_host" id="mail_host" value="{{ old('mail_host') }}" placeholder="Mail Host" />
                        ...
                        <div class="form-group {{ $errors->has('mail_port') ? ' has-error ' : '' }}">
                            ...
                            <input type="number" name="mail_port" id="mail_port" value="{{ old('mail_port') }}" placeholder="Mail Port" />
                        ...
                        <div class="form-group {{ $errors->has('mail_username') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="mail_username" id="mail_username" value="{{ old('mail_username') }}" placeholder="Mail Username" />
                        ...
                        <div class="form-group {{ $errors->has('mail_encryption') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="mail_encryption" id="mail_encryption" value="{{ old('mail_encryption') }}" placeholder="Mail Encryption" />
