    ...
    <div class="tabs tabs-full">
        ...
        <form method="post" action="<?php echo e(route('LaravelInstaller::environmentSaveWizard')); ?>" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <input type="hidden" name="app_version" value="4.0.10">

                <div class="form-group <?php echo e($errors->has('app_version') ? ' has-error ' : ''); ?>">
                    <label for="app_version">
                        App Version
                    </label>
                    <input type="text" name="app_version" id="app_version" value="4.0.10" placeholder="App Version" disabled/>
                ...
                <!-- <div class="block">
                    ...
                    <div class="info">
                        ...
                        <div class="form-group <?php echo e($errors->has('mail_driver') ? ' has-error ' : ''); ?>">
                            ...
                            <input type="text" name="mail_driver" id="mail_driver" value="<?php echo e(old('mail_driver')); ?>" placeholder="Mail Driver" />
                        ...
                        <div class="form-group <?php echo e($errors->has('mail_host') ? ' has-error ' : ''); ?>">
                            ...
                            <input type="text" name="mail_host" id="mail_host" value="<?php echo e(old('mail_host')); ?>" placeholder="Mail Host" />
                        ...
                        <div class="form-group <?php echo e($errors->has('mail_port') ? ' has-error ' : ''); ?>">
                            ...
                            <input type="number" name="mail_port" id="mail_port" value="<?php echo e(old('mail_port')); ?>" placeholder="Mail Port" />
                        ...
                        <div class="form-group <?php echo e($errors->has('mail_username') ? ' has-error ' : ''); ?>">
                            ...
                            <input type="text" name="mail_username" id="mail_username" value="<?php echo e(old('mail_username')); ?>" placeholder="Mail Username" />
                        ...
                        <div class="form-group <?php echo e($errors->has('mail_encryption') ? ' has-error ' : ''); ?>">
                            ...
                            <input type="text" name="mail_encryption" id="mail_encryption" value="<?php echo e(old('mail_encryption')); ?>" placeholder="Mail Encryption" />
...
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/zaheeecomm/resources/views/vendor/installer/environment-wizard.blade.php ENDPATH**/ ?>