        ...
        <div class="container">
            ...
            <div class="headerBottomRight">
                <div class="search-wrap">
                    <form method="POST" action="<?php echo e(URL::to('/shop')); ?>">
                        <?php echo csrf_field(); ?>
    ...
    <nav class="navbar navbar-expand-md">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="<?php echo e(Request::is('/shop') ? 'nav-item active' : 'nav-item'); ?>">
                        <a class="nav-link" href="<?php echo e(URL::to('/shop')); ?>"><?php echo app('translator')->get('website.All Categories'); ?></a>
                    </li>
...
<?php /**PATH /Users/fkhan/Projects/freelance/zahee/resources/views/web/headers/headerOne.blade.php ENDPATH**/ ?>