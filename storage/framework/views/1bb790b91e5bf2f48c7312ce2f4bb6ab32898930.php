...
<script src="<?php echo e(url('public/admin/js/clipboard.min.js')); ?>"></script>
<?php if(Request::path() == 'public/admin/dashboard/last_year' or Request::path() == 'public/admin/dashboard/last_month' or Request::path() == 'public/admin/dashboard/this_month'): ?>
...
//udpate address
	...
	$(document).on('click', '.deleteproductattributemodal', function(){
        ...
        $(document).on('click', '.getRange', function () {
            ...
            if (dateRange != '') {
                ...
                dateRange = dateRange.replace(/ /g, "");
                window.location = "<?php echo e(URL::to('public/admin/dashboard/dateRange=')); ?>" + dateRange;
            } else {
    ...
    function getSubCategory() {
        ...
        <?php if(Request::path() == 'public/admin/addProduct'): ?>
    ...
    Dropzone.options.myDropzone = {
        ...
        init: function () {
            this.on("success", function (file, response) {
                ...
                a.setAttribute('data-clipboard-text', '<?php echo e(url('public/admin/media/uploadimage')); ?>' + '/' + response);
...
<?php if(Request::path() == 'public/admin/deliveryboys/eagleview'): ?>
    <script async defer
...
<?php endif; ?>
<?php /**PATH /Users/fkhan/Projects/freelance/zahee/resources/views/admin/common/scripts.blade.php ENDPATH**/ ?>