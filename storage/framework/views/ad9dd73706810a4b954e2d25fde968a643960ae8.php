						...
						<form  enctype="multipart/form-data"   action="<?php echo e(URL::to('/process-login')); ?>" method="post">
							<?php echo e(csrf_field()); ?>
								...
								<div class="from-group mb-3">
									...
									<a href="<?php echo e(url('/guest_checkout')); ?>" type="submit" class="btn btn-primary btn-block">
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/zaheeecomm/resources/views/auth/login.blade.php ENDPATH**/ ?>