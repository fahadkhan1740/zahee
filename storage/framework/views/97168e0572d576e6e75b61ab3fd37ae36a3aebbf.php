    ...
    headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
		...
		success: function (res) {
            ...
            if(res.success == 0){
                ...
                swal("Congrates!", "<?php echo app('translator')->get('Product Added Successfully Thanks.Continue Shopping'); ?>", "success");
...
<?php /**PATH /var/www/html/resources/views/web/common/scripts.blade.php ENDPATH**/ ?>