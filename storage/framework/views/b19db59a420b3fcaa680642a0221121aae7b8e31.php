    ...
    <link rel="icon" href="<?php echo e(asset('public').'/'.$result['setting'][86]->value); ?>" type="image/gif">
    <?php endif; ?>
    ...
    <?php endif; ?>
<?php /**PATH /var/www/html/zaheeecomm/resources/views/web/common/meta.blade.php ENDPATH**/ ?>
