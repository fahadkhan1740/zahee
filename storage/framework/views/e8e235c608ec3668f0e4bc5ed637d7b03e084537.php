...
<script src="<?php echo e(asset('web/js/countDown.min.js')); ?>"></script>
                    ...
                    success: function (res) {
                        if (res.status == 'exceed') {
                            swal({
                                ...
                                text: "<?php echo app('translator')->get('website.Ops! Product is available in stock But Not Active For Sale. Please contact to the admin'); ?>&nbsp;&nbsp;<a href='mailto:anuva.kataria@imarkinfotech.com'><i class='fa fa-envelope-o' aria-hidden='true'></i></a>",
                ...
                jQuery.ajax({
                    ...
                    success: function (res) {
                        if (res['status'] == 'exceed') {
                            swal({
                                title: "Something Happened To Stock",
                                text: "<a href='mailto:anuva.kataria@imarkinfotech.com'><?php echo app('translator')->get('website.Ops! Product is available in stock But Not Active For Sale. Please contact to the admin'); ?></a>",
                                html: true, // add this if you want to show HTML
                                type: "error" // type can be error/warning/success
                            });
                        } else {
                            jQuery('.head-cart-content').html(res);
                            jQuery(parent).addClass('active');
                            location.href = "<?php echo e(URL::to('/viewcart')); ?>"
                        }
                    }
                });
            } else {
                swal("Please select the quantity", "<?php echo app('translator')->get('Quantity is not selected'); ?>", "error");
            }
        });
...
//add-to-Cart with custom options
        jQuery(document).on('click', '.add-to-Cart', function (e) {
            ...
            if (jQuery('#number').val() > 0) {
                ...
                jQuery.ajax({
                    ...
                    success: function (res) {
                        ...
                        if (res['status'] == 'exceed') {
                            swal({
                                title: "Something Happened To Stock",
                                text: "<?php echo app('translator')->get('website.Ops! Product is available in stock But Not Active For Sale. Please contact to the admin'); ?><br><a href='mailto:?subject=Query regarding product &amp;body=anuva.kataria@imarkinfotech.com'>Send Mail<i class='fa fa-envelope' aria-hidden='true'></i></a>",
                                html: true, // add this if you want to show HTML
                                type: "error" // type can be error/warning/success
                            });
                            // swal("Something Happened To Stock", "<?php echo app('translator')->get('website.Ops! Product is available in stock But Not Active For Sale. Please contact to the admin'); ?> <a>Contact through Email with admin</a>", "error");
                        } else {
                            jQuery('.head-cart-content').html(res);
                            jQuery(parent).addClass('active');
                ...
                swal("Please select the quantity", "<?php echo app('translator')->get('Quantity is not selcted'); ?>", "error");
            }
...
//tooltip enable
    ...
    jQuery(document).ready(function () {
        ...
        jQuery(document).on('change', '.<?php echo e($functionValue); ?>', function (e) {
            ...
            var <?php echo e($functionValue); ?> =
            jQuery("#<?php echo e($functionValue); ?>").val();
            ...
            var <?php echo e($attribute_sign); ?> =
            jQuery("#<?php echo e($attribute_sign); ?>").val(prefix);
...
<?php /**PATH /Users/fkhan/Projects/freelance/zahee/resources/views/web/common/scripts.blade.php ENDPATH**/ ?>