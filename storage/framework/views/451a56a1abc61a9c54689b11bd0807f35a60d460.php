                                    ...
                                    <table id="example1" class="table table-bordered table-striped" style="text-align: center;">
                                        ...
                                        <?php $__currentLoopData = $result['shipping_methods']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$shipping_methods): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <?php if($shipping_methods->methods_type_link=='flateRate' and $shipping_methods->shipping_methods_id=='1'): ?>                                            
                                                       <td><?php echo e($result['flate_rate']['flate_rate']->currency.' '.$result['flate_rate']['flate_rate']->flate_rate); ?></td>
                                                    <td>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/fkhan/Projects/freelance/zahee/resources/views/admin/shippingmethods/index.blade.php ENDPATH**/ ?>