                ...
                <div class="col-md-6">
                    <div class="footer-col quick-links">
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo e(url('/page/about-us')); ?>">FAQ</a></li>
                            <li><a href="<?php echo e(url('/page/about-us')); ?>">Sitemap </a></li>
                            <li><a href="<?php echo e(url('/page/about-us')); ?>">Delivery Terms</a></li>
                            <li><a href="<?php echo e(url('/page/about-us')); ?>">How to Order</a></li>
                            <li><a href="<?php echo e(url('/page/about-us')); ?>">Customer Service</a></li>
                            <li><a href="<?php echo e(url('/page/refund-policy')); ?>">Exchange and Returns</a></li>
                            <li><a href="<?php echo e(url('/page/privacy-policy')); ?>">Privacy Policy</a></li>
                            <li><a href="<?php echo e(url('/page/term-services')); ?>">Terms and Conditions</a></li>
                        </ul>
