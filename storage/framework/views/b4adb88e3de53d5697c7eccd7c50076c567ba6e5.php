					...
					<?php if(count($result['products']) > 0): ?>
                    	<?php $__currentLoopData = $result['products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$outOfStockData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><img src="<?php echo e(asset('/'.$outOfStockData->path)); ?>" alt="" width=" 100px" height="100px"></td>
                                <td width="45%">
                                    <strong><?php echo e($outOfStockData->products_name); ?></strong><br>
                                </td>
                                <!--<td>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/fkhan/Projects/freelance/zahee/resources/views/admin/reports/outofstock.blade.php ENDPATH**/ ?>